      ...
      <Carousel fade={true} controls={false} pause={false}>
        <Carousel.Item interval={4000}>
          <img
            ...
            src="https://images.unsplash.com/photo-1578320339840-73f0a565894c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2836&q=80" 
            alt="First slide"
          />
        </Carousel.Item>
        <Carousel.Item interval={4000}>
